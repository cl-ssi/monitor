...
<h3 class="mb-3"><i class="fas fa-lungs-virus"></i> Listado de exámenes Laboratorio UNAP</h3>
...
<a class="btn btn-outline-info btn-sm mb-3" href="{{ route('lab.suspect_cases.reports.minsal','unap') }}">
    Reporte MINSAL
</a>
<a class="btn btn-outline-info btn-sm mb-3" href="{{ route('lab.suspect_cases.reports.seremi','unap') }}">
    Reporte SEREMI
</a>
