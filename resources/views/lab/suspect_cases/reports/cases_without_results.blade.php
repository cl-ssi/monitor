...
@section('title', 'Casos creados sin resultados')

@section('content')

    <h3 class="mb-3">Casos creados sin resultados</h3>

    <form method="get" class="form-inline mb-3" action="{{ route('lab.suspect_cases.reports.cases_without_results') }}">
