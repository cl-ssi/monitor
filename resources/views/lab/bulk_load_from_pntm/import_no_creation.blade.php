  ...
  <div class="card-body">
      <div class="row">
          <div class="col-6">
              ...
              <span>Carga reception y resultado a monitor Esmeralda los datos descargados desde planilla de PNTM (Solo Bluelab derivadas desde HETG)</span>
...
{{--     </ul>--}}
    ...
    <form action="{{ route('lab.bulk_load_from_pntm.import.excel.no.creation') }}" method="post" enctype="multipart/form-data">
        @csrf
