...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission = Permission::create(['name' => 'SuspectCase: bulk load']);
        $permission = Permission::create(['name' => 'SuspectCase: import results']);
        ...
        $permission = Permission::create(['name' => 'SocialTracing: seremi']);
        $permission = Permission::create(['name' => 'SocialTracing: aps']);
