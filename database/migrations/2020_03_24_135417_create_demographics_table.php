    ...
    public function up()
    {
        Schema::create('demographics', function (Blueprint $table) {
            ...
            $table->enum('commune',['Arica', 'Camarones', 'Putre', 'General Lagos','Iquique', 'Alto Hospicio', 'Pozo Almonte', 'Camiña',
                                    ...
                                    'Tucapel', 'Yumbel', 'Alto Biobío', 'Chillán', 'Bulnes', 'Cobquecura', 'Coelemu', 'Coihueco', 'Chillán Viejo', 'El Carmen', 'Ninhue', 'Ñiquén',
                                    'Pemuco', 'Pinto', 'Portezuelo', 'Quillón', 'Quirihue', 'Ránquil',
                                    'San Carlos', 'San Fabián', 'San Ignacio', 'San Nicolás', 'Treguaco', 'Yungay','Temuco', 'Carahue', 'Cunco', 'Curarrehue',
